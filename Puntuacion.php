...
<body background="imagenes/general.png" style="background-size: 100%;background-repeat: no-repeat;">
    <div class="general">
        <div id="formulario">
            ...
            echo "<table id='tablaPersonal'>
            <tr>
                <th style='border-bottom: 5px double black'>Nombre</th>
                <th style='border-bottom: 5px double black'>Puntuacion</th>
            </tr>";
            $puntuacionPersonal = $_SESSION['puntuacionPersonal'];
            foreach($puntuacionPersonal as $registros){
                if (!empty($registros[0])){
                    echo "<tr><th>".$registros[0]."</th><th>".$registros[1]."</th></tr>";
                }
            }
            ...
            ?>
            <input type="button" value="Volver" id="botonPuntuacion" onclick="location='Index.html'" style="margin:10px auto;"/>
    </div>
</body>
</html>
